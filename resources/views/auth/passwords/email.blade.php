...
@section('content')
            ...
            <div class="row content align-items-center gy-4">
                <div class="col-md-6 mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <defs>
                            <linearGradient id="b7709055-0dd4-48d6-ac10-5a758f15d1a1" x1="443.56" y1="792.13"
                                x2="443.56" y2="251.5" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                                <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                                <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                            </linearGradient>
                            <linearGradient id="f59ba046-7ebe-407e-be3d-c62856fc1078" x1="712" y1="788.54"
                                x2="712" y2="248.5" xlink:href="#b7709055-0dd4-48d6-ac10-5a758f15d1a1" />
                        </defs>
                ...
                <div class="col-md-5 text-center loginform">
                    <h2 class="signin-text mb-3 h5 fw-semibold mb-4"> Digite seu email cadastrado</h2>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class=" mb-3">
                            <label for="email"
                                class="col-form-label text-md-end visually-hidden">{{ __('Email Address') }}</label>
    ...
    <div class="modal fade" id="modal-nao-cadastrado" tabindex="-1" data-bs-keyboard="false" role="dialog"
            ...
            <div class="modal-content border-0" style="background: #c4c4c4">
                <div class="modal-body py-3">
                    <div class="text-uppercase text-center py-3 px-4">
                        <div class="fs-5 mb-3">
                            USUÁRIO<br> NÃO CADASTRADO
                        </div>
                        <div class="mx-auto" style="max-width: 140px">
                            <div class="">
                                <a href="{{ route('register') }}"
                                    class="text-uppercase btn-sm py-2 btn btn-primary rounded-1 px-3 w-100">
                                    <div class="px-2 small">Cadastre-se</div>
                                </a>
                            </div>
                            <div class="">
                                <span class="bg-white rounded-1 d-inline-block mt-2 w-100">
                                    <button type="button"
                                        class="text-uppercase btn-sm py-2 btn btn-outline-primary rounded-1 px-3 w-100"
    ...
    <!-- Modal redefinição de senha enviada -->
    <div class="modal fade" id="modal-redefinicao-enviada" tabindex="-1" data-bs-keyboard="false" role="dialog"
        aria-labelledby="modalTitleId" aria-hidden="true" style="background: rgba(255,255,255, .8);">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document" style="max-width: 350px">
            <div class="modal-content border-0" style="background: #c4c4c4">
                <div class="modal-body py-3">
                    <div class="text-uppercase text-center py-4 px-4">
                        <div class="fs-5 mb-3">
                        ...
                        <div class="mx-auto" style="max-width: 140px">
                            ...
                            <div class="">
                                <span class="bg-white rounded-1 d-inline-block mt-1 w-100">
                                    <button type="button"
                                        class="text-uppercase btn-sm py-2 btn btn-outline-primary rounded-1 px-3 w-100"
                                        data-bs-dismiss="modal" aria-label="Close">
                                        <div class="px-2 small">Fechar</div>
    ...
    @if ($errors->any())
        <script>
            window.onload = function() {
                let myModal = new bootstrap.Modal(document.getElementById('modal-nao-cadastrado'))
                myModal.show()
            }
        </script>
    @endif
    ...
    @if (session('status'))
        <script>
            window.onload = function() {
                let myModal = new bootstrap.Modal(document.getElementById('modal-redefinicao-enviada'))
                myModal.show()
            }
        </script>
    @endif
