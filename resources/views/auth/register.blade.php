        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <section class="contato">
                <div class="row justify-content-center">
                    <h1 class="h2 text-center mb-4">Cadastro</h1>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="">
                                        <input id="name" type="text"
                                            ...
                                            value="{{ old('name') }}" placeholder="Nome" autocomplete="name" autofocus
                                            required>
                                        @error('name')
            ...
            <section id="cards-container">
                ...
                <input type="radio" class="btn-check" name="plano" id="option2" value="premium"
                    autocomplete="off" {{ old('plano') == 'premium' ? 'checked' : '' }}>
