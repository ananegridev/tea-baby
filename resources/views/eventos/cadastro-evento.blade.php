    ...
    <section class="contato">
        <div class="container">
            ...
            <div class="col-md-4 text-center eventoform">
                <h1 class="signin-text mb-3 h2"> Cadastro de Evento</h1>
                <form method="POST" action="{{ route('cadastro-evento.store') }}">
                    @csrf
                    ...
                    <div class="form-group p-4">
                        ...
                        <!-- Mês previsto -->
                        <input id="mes_gestacao" type="{{ old('mes_gestacao') ? 'month' : 'text' }}"
                            onfocus="(this.type='month')"
                            class="form-control @error('mes_gestacao') is-invalid mb-0 @enderror" name="mes_gestacao"
                            value="{{ old('mes_gestacao') }}" required placeholder="Mês Previsto do Parto">
                        @error('mes_gestacao')
                        ...
                        <input id="sexo_bebe" type="text"
                            ...
                            value="{{ old('sexo_bebe') }}" required placeholder="Sexo do Bebê">
                        @error('sexo_bebe')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group p-4">
                        ...
                        <!-- Data do evento -->
                        <input id="data_evento" type="{{ old('data_evento') == null ? 'text' : 'date' }}"
                            class="form-control @error('data_evento') is-invalid mb-0 @enderror" name="data_evento"
                            value="{{ old('data_evento') }}" onfocus="(this.type='date')" required
                        ...
                        <input id="nome_baby" type="text"
                            ...
                            value="{{ old('nome_baby') }}" required placeholder="Nome do Baby">
                        @error('nome_baby')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <input id="link_pagina" type="text"
                            ...
                            value="{{ old('link_pagina') }}" required placeholder="Link da Página">
                        @error('link_pagina')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                        <div class="text-start" id="exibir-link-pagina"
                            style="@if (old('link_pagina') == null) display: none @endif">
                            <div>Exibição do link:</div>
                            <strong id="link-pagina">{{ route('landing-page-one', '') }}/{{ old('link_pagina') }}</strong>
                        </div>
                    </div>
                    ...
                    <div class="form-group p-4">
                        ...
                        <input id="titulo" type="text" class="form-control @error('titulo') is-invalid mb-0 @enderror"
                            name="titulo" value="{{ old('titulo') }}" required="titulo" placeholder="Título do evento">
                        @error('titulo')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <textarea class="form-control @error('sobre') is-invalid mb-0 @enderror" name="sobre"
                            placeholder="Digite uma descrição sobre o evento" required>{{ old('sobre') }}</textarea>
                        @error('sobre')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <input id="celular" type="text"
                            ...
                            value="{{ old('celular') }}" required="celular" placeholder="Celular">
                        @error('celular')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group p-4">
                        ...
                        <input id="cep" type="text" class="form-control @error('cep') is-invalid mb-0 @enderror"
                            name="cep" value="{{ old('cep') }}" required placeholder="CEP">
                        ...
                        <input id="numero_endereco" type="text"
                            ...
                            name="numero_endereco" value="{{ old('numero_endereco') }}" required placeholder="Número">
                        ...
                        <input id="complemento" type="text"
                            ...
                            value="{{ old('complemento') }}" required placeholder="Complemento">
                        @error('complemento')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <input id="cidade" type="text"
                            ...
                            value="{{ old('cidade') }}" required placeholder="Cidade">
                        @error('cidade')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <input id="estado" type="text"
                            ...
                            value="{{ old('estado') }}" required placeholder="Estado">
                        @error('estado')
                            <span class="invalid-feedback mb-3 text-start" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <input id="ponto_referencia" type="text"
                            ...
                            name="ponto_referencia" value="{{ old('ponto_referencia') }}" required
                    ...
                    <div class="form-group p-4">
                        ...
                        @if ($categoriaEventos->count() == 0)
                            <div class="text-center text-danger">
                                Não há categorias de eventos criadas
                            </div>
                        @endif
                        ...
                        <div class="categorias-eventos overflow-hidden">
                            <!-- Carousel -->
                                                    ...
                                                    @foreach ($grupoCategoria as $item)
                                                        <div class="overflow-hidden mx-auto mx-lg-0"
                                                            ...
                                                            <input type="radio" class="btn-check"
                                                                ...
                                                                {{ old('categoria_evento_id') == $item->id ? 'checked' : '' }}>
